...
},{"../../server/world/items.js":37,"./browser.js":1}],31:[function(require,module,exports){
...
function getMaterialName(id) {
	return Object.keys(temp_materials).filter(function(key) {
		return temp_materials[key] == id;
	})
}
var object_cache = [];
var vegetation_indexes = {
...
mp.events.add("render", () => {
	...
	if (hitData) {
		if (materials[hitData.material] == 3) {
			mp.game.graphics.drawText("Is Bush", [0.5, 0.55], {
				font: 4,
				color: [255, 255, 255, 200],
				scale: [0.3, 0.3],
				outline: true,
...
},{"./materials.js":18}],34:[function(require,module,exports){
...
},{"./vector.js":32}],36:[function(require,module,exports){
var Zombie = class {
    constructor() {
        this._setup();
    }
